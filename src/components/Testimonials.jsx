...
const Testimonials = () => {
  return (
    <div className='container mx-auto py-4 lg:px-32 w-full overflow-hidden' id='Testimonials'>
      ...
      <div className='flex flex-row justify-center gap-8'>
        {testimonialsData.map((Testimonials, index)=>(
            <div key={index} className='max-w-[340px]   shadow-lg rounded px-4 py-2 text-center'>
